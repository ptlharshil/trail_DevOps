...
var getSortDirectionFromOptions = function (options) {
    return (options.sortable && options.sortDirection) || Column_1.ColumnSortDirection.None;
};
var getSortOrder = function (sortDirection, options) {
    return (sortDirection !== Column_1.ColumnSortDirection.None && options.sortOrder) || -1;
};
var checkUndefined = function (value, defaultValue) {
...
var getSortDirection = function (sortDirection) {
    if (sortDirection === Column_1.ColumnSortDirection.None)
        return Column_1.ColumnSortDirection.Ascending;
    return sortDirection === Column_1.ColumnSortDirection.Ascending ? Column_1.ColumnSortDirection.Descending : Column_1.ColumnSortDirection.None;
};
...
var createColumn = function (name, options) {
    var temp = options || {};
    var sortDirection = getSortDirectionFromOptions(temp);
    return {
...
var parseDateColumnValue = function (column, value) {
    if (!(0, exports.isDateColum)(column) || !value) {
        return '';
    }
    switch (column.dataType) {
        case Column_1.ColumnDataType.DateTime:
